...
namespace ScheduleManagementSession01.Extensions
{
    public static class StartupExtensions
    {
        ...
        public static void AddBussinessService(this IServiceCollection services)
        {
            ...
            services.AddScoped<IFreeDayService, Services.Core.FreeDayService>();
            ...
            services.AddScoped<IFreePhysioScheduleService, Services.Core.FreePhysioScheduleService>();
            services.AddScoped<IFeeService, Services.Core.FeeService>();
            services.AddScoped<ITypeOfFeeService, Services.Core.TypeOfFeeService>();
            services.AddScoped<IPaymentService, Services.Core.PaymentService>();
            services.AddScoped<IScheduleTypeService, Services.Core.ScheduleTypeService>();
            services.AddScoped<IFeedbackService, Services.Core.FeedbackService>();
            services.AddScoped<IScheduleDetailService, Services.Core.ScheduleDetailService>();
            services.AddScoped<IExerciseFeedbackService, Services.Core.ExerciseFeedbackService>();
            services.AddScoped<IVideoService, Services.Core.VideoService>();
            services.AddScoped<IImageService, Services.Core.ImageService>();
            services.AddScoped<IExerciseVideoService, Services.Core.ExerciseVideoService>();
            services.AddScoped<IExerciseImageService, Services.Core.ExerciseImageService>();
