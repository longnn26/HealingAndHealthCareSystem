...
namespace HealingAndHealthCareSystem.Controllers
{
    ...
    public class ExerciseController : ControllerBase
    {
        ...
        private readonly IExerciseService _exerciseservice1;
        public ExerciseController(IExerciseService exerciseService, IExerciseService exerciseService1)
        {
            _exerciseservice = exerciseService;
            _exerciseservice1 = exerciseService1;
        }
